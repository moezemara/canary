...
monster.attacks = {
		{name = "melee", interval = 2000, minDamage = -0, maxDamage = -90},
		{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 3000, chance = 20, length = 8, spread = 3, minDamage = -40, maxDamage = -50, effect = CONST_ME_POISON},
}
