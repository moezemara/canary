...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_LIFEDRAIN, interval = 1000, chance = 6, range = 1, minDamage = -1, maxDamage = -39},
		{name = "speed", interval = 1000, chance = 8, range = 7, speedchange = -800, duration = 5000},
		{name = "drunk", interval = 1000, chance = 10, range = 7},
		{name = "outfit", interval = 1000, chance = 9, range = 7, duration = 5000},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 1000, chance = 20, radius = 6, target = 0, minDamage = -6, maxDamage = -18},
...
monster.defenses = {
	defense = 8,
	armor = 3,
		{name = "combat", type = COMBAT_HEALING, interval = 1000, chance = 10, minDamage = 3, maxDamage = 9},
