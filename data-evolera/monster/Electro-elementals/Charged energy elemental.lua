...
monster.description = "an charged energy Elemental"
...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 20, range = 6, radius = 4, target = 1, minDamage = -168, maxDamage = -200, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY},
...
monster.loot = {
	...
	{id = 7838, chance = 3200, maxCount = 3},
}
