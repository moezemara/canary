...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 1000, chance = 12, length = 7, spread = 0, minDamage = -100, maxDamage = -180, effect = CONST_ME_BUBBLES},
		...
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 1000, chance = 12, range = 7, radius = 3, target = 0, minDamage = -90, maxDamage = -155, effect = CONST_ME_BUBBLES},
}
