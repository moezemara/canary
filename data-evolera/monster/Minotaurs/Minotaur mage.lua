...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 1000, chance = 14, range = 7, minDamage = -15, maxDamage = -45, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGY},
		{name = "combat", type = COMBAT_FIREDAMAGE, interval = 2000, chance = 10, range = 7, radius = 1, target = 1, minDamage = -35, maxDamage = -95, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA},
