...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 22, range = 7, minDamage = -55, maxDamage = -125, shootEffect = CONST_ANI_SUDDENDEATH},
		{name = "combat", type = COMBAT_MANADRAIN, interval = 1000, chance = 13, range = 7, minDamage = -10, maxDamage = -170, effect = CONST_ME_REDSHIMMER},
}
