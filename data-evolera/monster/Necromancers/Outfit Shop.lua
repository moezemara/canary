local mType = Game.createMonsterType("Outfit Shop")
local monster = {}

monster.description = "a outfit shop"
...
monster.defenses = {
	defense = 20,
	armor = 20,
		{name = "combat", type = COMBAT_HEALING, interval = 10000, chance = 0, minDamage = 42, maxDamage = 68},
}
