local mType = Game.createMonsterType("Mutated Thornback Tortoise")
local monster = {}

monster.description = "a mutated thornback tortoise"
...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 103, attack = 400},
}
