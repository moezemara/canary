local mType = Game.createMonsterType("Ice Witch Boss")
local monster = {}

monster.description = "an ice witch boss"
...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 1000, chance = 7, length = 6, spread = 3, minDamage = 1000, maxDamage = -2000, effect = CONST_ME_ICEATTACK},
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 2000, chance = 15, length = 4, spread = 2, minDamage = -100, maxDamage = -210, effect = CONST_ME_ICEAREA},
