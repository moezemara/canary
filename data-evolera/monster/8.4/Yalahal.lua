local mType = Game.createMonsterType("Yalahal")
local monster = {}

monster.description = "a yalahal"
...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 50, attack = 6000},
		{name = "combat", type = COMBAT_LIFEDRAIN, interval = 1000, chance = 40, range = 1, minDamage = -8000, maxDamage = -9000},
		{name = "speed", interval = 1000, chance = 10, range = 7, speedchange = -8000, duration = 10000, effect = CONST_ME_REDSHIMMER},
}
