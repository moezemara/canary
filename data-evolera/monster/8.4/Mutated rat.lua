...
monster.attacks = {
		{name = "melee", interval = 2000, minDamage = -20000, maxDamage = -30000},
		{name = "combat", type = COMBAT_MANADRAIN, interval = 1000, chance = 13, range = 1, minDamage = -2000, maxDamage = -3000},
}
