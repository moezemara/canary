local mType = Game.createMonsterType("Mutated Frost Dragon")
local monster = {}

monster.description = "a mutated frost dragon"
...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_LIFEDRAIN, interval = 3000, chance = 10, length = 7, spread = 3, minDamage = 400, maxDamage = -1500, effect = CONST_ME_POFF},
		{name = "speed", interval = 2000, chance = 11, length = 7, spread = 3, speedchange = -650, effect = CONST_ME_ICEATTACK},
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 2000, chance = 18, radius = 4, target = 1, minDamage = 0, maxDamage = -480, effect = CONST_ME_ICEAREA, shootEffect = CONST_ANI_SMALLICE},
