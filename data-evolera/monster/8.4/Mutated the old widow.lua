local mType = Game.createMonsterType("Mutated The Old Widow")
local monster = {}

monster.description = "a mutated the Old Widow"
...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 110, attack = 130},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 3000, chance = 18, range = 7, minDamage = -200, maxDamage = -350, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_POISON},
		...
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 12, radius = 4, target = 0, minDamage = -300, maxDamage = -350, shootEffect = CONST_ANI_POISON},
}
...
monster.summons = {
		{name = "giant spider", chance = 13, interval = 1000, max = 1},
}
