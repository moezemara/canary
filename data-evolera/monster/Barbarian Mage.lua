local mType = Game.createMonsterType("Barbarian Mage")
local monster = {}

monster.description = "a barbarian mage"
...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 34, range = 7, radius = 1, target = 1, minDamage = -800000, maxDamage = -1000000, shootEffect = CONST_ANI_SNOWBALL},
