...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 45, attack = 24},
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 1000, chance = 24, range = 7, minDamage = -50, maxDamage = -110, shootEffect = CONST_ANI_LARGEROCK},
}

monster.defenses = {
	defense = 20,
	armor = 26,
		{name = "combat", type = COMBAT_HEALING, interval = 1000, chance = 10, minDamage = 5, maxDamage = 15},
}
