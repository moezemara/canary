local mType = Game.createMonsterType("Lord Stony Golem")
local monster = {}

monster.description = "a stony golem"
monster.experience = 1100000000
monster.outfit = {
	lookType = 67,
	lookHead = 0,
	lookBody = 0,
...
monster.raceId = 0
monster.health = 135000000
monster.maxHealth = 135000000
monster.race = "undead"
monster.corpse = 9867
monster.speed = 660
monster.manaCost = 0
...
monster.attacks = {
		{name = "melee", interval = 2, chance = 100, range = 1, minDamage = -1500000, maxDamage = -2050000},
		...
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 100, chance = 14, minDamage = -300000, maxDamage = -500000},
}
