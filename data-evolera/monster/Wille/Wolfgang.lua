local mType = Game.createMonsterType("Wolfgang")
local monster = {}

monster.description = "a wolfgang"
...
monster.raceId = 0
monster.health = 125000000
monster.maxHealth = 125000000
monster.race = "blood"
monster.corpse = 2826
monster.speed = 650
monster.manaCost = 0
...
monster.attacks = {
		{name = "melee", interval = 200, skill = 150, attack = 365000},
