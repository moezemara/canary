local mType = Game.createMonsterType("Blue Knight")
local monster = {}

monster.description = "a blue knight"
...
monster.raceId = 0
monster.health = 110000000
monster.maxHealth = 110000000
monster.race = "blood"
monster.corpse = 6080
monster.speed = 650
monster.manaCost = 0
...
monster.attacks = {
		{name = "melee", interval = 200, skill = 150, attack = 350000},
