...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 71, attack = 64},
		...
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 2000, chance = 14, length = 8, spread = 4, minDamage = -150, maxDamage = -210, effect = CONST_ME_BLUEBUBBLE},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 1000, chance = 12, length = 8, spread = 3, minDamage = -190, maxDamage = -250, effect = CONST_ME_SMALLPLANTS},
		{name = "combat", type = COMBAT_ICEDAMAGE, interval = 1000, chance = 14, range = 7, target = 1, minDamage = -85, maxDamage = -120, shootEffect = CONST_ANI_SMALLICE},
}
