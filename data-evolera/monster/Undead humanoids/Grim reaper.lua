...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 15, range = 7, target = 1, minDamage = 0, maxDamage = -60, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA},
		...
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 14, radius = 4, target = 0, minDamage = 0, maxDamage = -395, effect = CONST_ME_REDSPARK},
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 3000, chance = 19, length = 7, spread = 3, minDamage = 0, maxDamage = -300, effect = CONST_ME_EXPLOSIONAREA},
}
