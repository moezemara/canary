...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 18, attack = 18},
		{name = "combat", type = COMBAT_FIREDAMAGE, interval = 1000, chance = 20, range = 7, minDamage = -25, maxDamage = -55, shootEffect = CONST_ANI_FIRE},
		{name = "combat", type = COMBAT_FIREDAMAGE, interval = 1000, chance = 13, range = 7, radius = 1, target = 1, shootEffect = CONST_ANI_FIRE},
}
