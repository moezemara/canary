local mType = Game.createMonsterType("Mage Ghost")
local monster = {}

monster.description = "a Mage Ghost"
...
monster.attacks = {
		{name = "melee", interval = 1, skill = 100, attack = 500000},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 1, chance = 1, range = 7, minDamage = -500065, maxDamage = -1800000, shootEffect = CONST_ANI_EARTH},
