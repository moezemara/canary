...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 3000, chance = 25, range = 7, minDamage = -40, maxDamage = -70, shootEffect = CONST_ANI_THROWINGSTAR},
		{name = "melee", interval = 1000, chance = 30, range = 7, radius = 3, target = 0, minDamage = -0, maxDamage = -0, effect = CONST_ME_REDNOTE},
}
