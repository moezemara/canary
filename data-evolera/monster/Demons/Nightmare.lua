...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 17, range = 7, target = 1, minDamage = -130, maxDamage = -170, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 13, range = 7, radius = 4, target = 1, minDamage = -250, maxDamage = -350, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISON},
}
...
monster.defenses = {
	...
	armor = 25,
		...
		{name = "speed", interval = 2000, chance = 20, speedchange = 560, duration = 80000},
}
