...
monster.attacks = {
		{name = "melee", interval = 2000, skill = 140, attack = 160},
		{name = "combat", type = COMBAT_PHYSICALDAMAGE, interval = 2000, chance = 18, range = 7, minDamage = 0, maxDamage = -650, shootEffect = CONST_ANI_LARGEROCK},
}
