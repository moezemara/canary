local mType = Game.createMonsterType("Xynex")
local monster = {}

monster.description = "a xynex"
...
monster.attacks = {
		...
		{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 17, range = 2, target = 1, minDamage = -3000000, maxDamage = -3800000, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA},
		{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 40, range = 2, radius = 4, target = 1, minDamage = -2000000, maxDamage = -3600000, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISON},
}
