...
combat_1:setParameter(COMBAT_PARAM_EFFECT, 44)
combat_1:setParameter(COMBAT_PARAM_DISTANCEEFFECT, 35)
combat_1:setArea(createCombatArea(area_1))
function onGetFormulaValues_1(player, level, maglevel)
    local c = level / 5 + maglevel
    return -(c * 44 + 3200), -(c * 44 + 1350)
end
...
combat_2:setParameter(COMBAT_PARAM_EFFECT, 17)
...
spell:id(547)
spell:name("Mega Strike")
spell:words("exori mega bomb")
spell:level(45000)
spell:mana(1000)
