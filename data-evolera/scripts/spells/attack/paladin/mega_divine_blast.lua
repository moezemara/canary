...
combat_1:setParameter(COMBAT_PARAM_EFFECT, 49)
...
spell:id(542)
spell:name("Mega Divine Blast")
spell:words("exevo mega san")
spell:level(750000)
spell:mana(9000)
